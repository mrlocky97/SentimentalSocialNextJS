...
async function trainAndTestModel() {
  console.log('🚀 Iniciando entrenamiento del modelo de análisis de sentimientos...\n');
  ...
  try {
    ...
    console.log('🧪 Probando el modelo con ejemplos de redes sociales y marketing...\n');
    ...
    testCases.forEach((text, index) => {
      ...
      console.log(`   📈 Predicción: ${prediction.label.toUpperCase()} (${confidence}% confianza)`);
      console.log('');
    });

    // Estadísticas adicionales
    console.log('📈 Análisis de Rendimiento:');
    console.log(`   Dataset: ${enhancedTrainingData.length} ejemplos de alta calidad`);
    console.log(`   Características: Social media, emojis, sarcasmo, multilingüe`);
    console.log(`   Tiempo de entrenamiento: ${trainingTime}ms`);
    console.log(`   Optimizado para: Twitter, Instagram, marketing, brands`);
    console.log('');

    console.log('🏆 Mejoras implementadas:');
    console.log('   ✅ Eliminación de duplicados (reducido de ~4k a ejemplos únicos)');
