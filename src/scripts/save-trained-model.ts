...
async function saveTrainedModel() {
  console.log(
    "🚀 Iniciando proceso de entrenamiento y guardado del modelo...\n",
  );
  ...
  try {
    ...
    const modelPath = path.join(
      __dirname,
      "../data/trained-sentiment-model.json",
    );
    ...
    console.log(
      `   Tamaño del archivo: ${(fileStats.size / 1024).toFixed(2)} KB`,
    );
    ...
    console.log(
      "💡 El modelo está listo para ser cargado y utilizado en la aplicación.",
    );
    console.log(
