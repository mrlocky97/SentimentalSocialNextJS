...
export function configureServices(): void {
  ...
  container.registerSingleton(TOKENS.SENTIMENT_ENGINE, () => new SentimentAnalysisEngine());
  ...
  container.registerSingleton(TOKENS.CORRELATION_SERVICE, () => correlationService);
