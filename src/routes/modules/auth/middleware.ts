 ...
 */
export const authRateLimit = (limit: number = 5, windowMs: number = 15 * 60 * 1000) => {
...
export const validateRegisterRequest = (req: Request, res: Response, next: NextFunction) => {
  try {
    const { email, password, displayName, username }: RegisterRequest = req.body;
...
export const validateRefreshTokenRequest = (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    if (typeof refreshToken !== 'string' || refreshToken.trim().length === 0) {
      throw new ValidationError('Invalid refresh token format', ErrorCode.INVALID_TOKEN);
    }
 ...
 */
export const setAuthSecurityHeaders = (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const logAuthRequest = (req: Request, res: Response, next: NextFunction) => {
