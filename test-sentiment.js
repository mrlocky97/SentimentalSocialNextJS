...
const sentiment_analysis_service_1 = require("./src/services/sentiment-analysis.service");
async function testEnhancedSentimentAnalysis() {
    const service = new sentiment_analysis_service_1.SentimentAnalysisService();
